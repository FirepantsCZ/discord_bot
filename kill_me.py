...
assert pafy.new("https://www.youtube.com/watch?v=4bvLaYLD1HI", ydl_opts=ytdl_format_options).length != 0 #Sanity checks
...
async def lyrics(ctx, song="", artist=""):
    ...
    try:
        ...
        em = discord.Embed(title="Error :octagonal_sign:", description="Error while searching for lyrics", color=0xff0000)
        await ctx.send(embed=em)
